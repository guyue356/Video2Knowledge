...
![上传内容](Assets/上传内容.png)

### 资产管理

![资产管理](Assets/资产管理.png)

### 实时处理进度

语音转录期间会同步展示当前阶段、单步进度、整体进度、已完成步骤与等待中的后续任务。

![语音转录实时进度](Assets/处理进度-语音转录.png)

### 资产详情

处理完成后，可以在统一详情页查看原始视频、播放或下载抽取后的音频，并浏览、导出各阶段生成的内容。

#### 原始视频

![资产详情原始视频](Assets/资产详情-原始视频.png)

#### 音频播放

![资产详情音频播放](Assets/资产详情-音频播放.png)

#### 转录文本

![资产详情转录文本](Assets/资产详情-转录文本.png)

#### 结构化知识

![资产详情知识提取](Assets/资产详情-知识提取.png)

### 阶段结果

| 转录文本 | 章节结构 |
| :---: | :---: |
| ![详情页转录文本](Assets/详情页-转录文本.png) | ![详情页章节结构](Assets/详情页-章节结构.png) |

| 最终产物 |
| :---: |
| ![详情页产物](Assets/详情页-产物.png) |
...
脚本会检查 Conda、Node.js、ffmpeg，创建或复用 `video2techblog` Conda 环境，安装后端与前端依赖，并启动：
